...
import { CustomElement, Declaration, Export, JavaScriptModule, Package, ClassMember } from 'custom-elements-json/schema';

describe.skip('helpers', () => {
  describe('PackageDoc', () => {
    describe('hasModules', () => {
      const fixture: Package = {schemaVersion: '', modules: [{kind: 'javascript-module', path: '', declarations: []}]};
  ...
  describe('ModuleDoc', () => {
    describe('hasExports', () => {
      const fixture: JavaScriptModule = {kind: 'javascript-module', path: '', declarations: [{kind: 'class', name: ''}], exports: [{kind: 'js', name: '', declaration: {name: ''}}]};
